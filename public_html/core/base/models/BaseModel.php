...
class BaseModel extends BaseModelMethods
{
     ...
     *       'join_table2' => [
     *       'table' => 'join_table2',
     *       'fields' => ['id as p2_id', 'name as p2_name'],
     *      'type' => 'left',
     *       'where' => ['name' => 'Ошейник для кошек'],
     *       'operand' => ['='],
     *       'condition' => ['AND'],
     ...
     * except => ['исключение1', 'исключение 2'] - исключает данные элементы массива из добавления в запрос
     * return_id => true|false - возвращать или нет идентификатор всталвенной записи
     * @return mixed
     */
